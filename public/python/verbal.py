...
preprocessor = ColumnTransformer([
    ('categoric', cat_pipe(encoder='onehot'), ['Soal1', 'Soal2', 'Soal3','Soal4', 'Soal5', 'Soal6','Soal7', 'Soal8', 'Soal9', 'Soal10']),
])
...
X_pred = pd.read_csv("C:/xampp/htdocs/data/public/python/Data/testing.csv")
