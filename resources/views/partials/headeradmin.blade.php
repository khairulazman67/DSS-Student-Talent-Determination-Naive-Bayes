<div class="py-1 flex justify-end bg-purple-600">
    ...
    <div>
        <div class="bg-purple-400 flex flex-row justify-center space-x-4 py-2">
            ...
            <div class="py-6">
                <h2 class="flex justify-center font-bold text-lg uppercase text-white">Sistem Penentuan Bakat Mahasiswa Jurusan TIK</h2>
                <h2 class="flex justify-center text-lg font-mono font-semibold text-white">Menggunakan Metode Naive Bayes</h2>
            </div>
        </div>
    </div>
    <div class="">
            ...
            <div class="navbar-collapse flex-grow items-cente px-12">
                <ul class="navbar-nav flex flex-row pl-0 list style-none mr-auto justify-center text-lg text-white">
                    ...
                    <li class="nav-item py-2 px-6 bg-purple-700 hover:bg-purple-300 hover:text-black">
                        <a href="{{ url('admin/pengujian') }}">Data Training</a>
                    </li>
                    <li class="nav-item py-2 px-6 bg-purple-700 hover:bg-purple-300 hover:text-black">
                        <a href="{{ url('admin/pengujian') }}">Histori</a>
                    </li>
                </ul>
            </div>
        </nav>
