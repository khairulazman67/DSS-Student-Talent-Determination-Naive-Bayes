...
<body>
    <section id="kata">
        <div class="border-black mx-64 border-b-2">
            <h1 class="text-center pt-11 text-4xl uppercase font-bold">Sistem Penentuan Bakat Mahasiswa TIK</h1>
            <h4 class="text-center text-xl uppercase">Menggunakan Metode Naive Bayes</h4>
        </div>
    </section>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="py-2 flex justify-end mr-6 space-x-3">
                                    ...
                                    @endif --}}
                                    <a href="{{ url('register') }}"
                                        class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Register</a>
                                    <button type="submit"
